...
public class MainActivity extends Activity implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
...
//		boolean checkBoxValue = sharedPreferences.getBoolean("CheckBox_Value", false);
			...
			num = sharedPreferences.getInt("storedroute", -1);
	...
	//	Button button2=(Button)findViewById(R.id.button2);
		...
		route1= (TextView)findViewById(R.id.textView4);
		//Criteria criteria = new Criteria();
		
		viewPlate.setText(name);
		switch(num){
		case R.id.routeA:route1.setText("A");
		break;
		case R.id.routeB:route1.setText("B");
		break;
		case R.id.routeC:route1.setText("C");
		break;
		case R.id.routeD:route1.setText("D");
		break;
		case R.id.routeE:route1.setText("E");
		break;
		default:route1.setText("Error");
		break;
		}
		//route1.setText(num);
      ...
      /*  listener = new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            	...
            	viewPlate.setText(key);
            	else if(key.equals("storedroute"))
                	route1.setText(key);
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		...
		if(key.equals("storedName"))
        	viewPlate.setText(sharedPreferences.getString(key, null));
        	else if(key.equals("storedroute")){
        		switch(sharedPreferences.getInt(key, -1)){
        		case R.id.routeA:route1.setText("A");
        		break;
        		case R.id.routeB:route1.setText("B");
        		break;
